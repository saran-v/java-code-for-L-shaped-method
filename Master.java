...
public class Master {
	...
	public static void setLb(double[] lb) {
		Master.lb = lb;
	}
	...
	public static void setUb(double[] ub) {
		Master.ub = ub;
	}
	...
	{
		Master.lb = new double[Master.mastRngs.length];
		Master.ub = new double[Master.mastRngs.length];
